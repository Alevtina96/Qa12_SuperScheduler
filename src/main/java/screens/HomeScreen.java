...
public class HomeScreen extends BaseScreen{
    ...
    @FindBy(xpath = "xpath = \"//*[@resource-id='com.example.svetlana.scheduler:id/fab_main']\"")
    ...
    public HomeScreen isPlusButtonPresentAssert(){
        new WebDriverWait(driver,10)
                .until(ExpectedConditions.visibilityOf(plusBtn));
        Assert.assertTrue(plusBtn.isDisplayed()); //правда ли что это класс buttonDisplayed
        return this;
    }
